...
[Get Started](/introduction) ## [​](\#what-is-a-crew)  What is a Crew?
...
[Get Started](/introduction) ![Portkey CrewAI Header Image](https://raw.githubusercontent.com/siddharthsambharia-portkey/Portkey-Product-Images/main/Portkey-CrewAI.png)
...
## [​](\#production-features-with-portkey-configs)  Production Features with Portkey Configs
...
### [​](\#5-detailed-logging)  5\. Detailed Logging

Logs are essential for understanding agent behavior, diagnosing issues, and improving performance. They provide a detailed record of agent activities and tool use, which is crucial for debugging and optimizing processes.

Access a dedicated section to view records of agent executions, including parameters, outcomes, function calls, and errors. Filter logs based on multiple parameters such as trace ID, model, tokens used, and metadata.

### [​](\#6-enterprise-security-features)  6\. Enterprise Security Features
...
[Agent Monitoring with OpenLIT](/how-to/openlit-observability) [Browserbase Web Loader](/tools/browserbaseloadtool)
...
[Get Started](/introduction) # [​](\#langtrace-overview)  Langtrace Overview
...
[Agent Monitoring with AgentOps](/how-to/agentops-observability) [Agent Monitoring with OpenLIT](/how-to/openlit-observability)
...
[Get Started](/introduction) ## [​](\#customizable-attributes)  Customizable Attributes
...
[Get Started](/introduction) # [​](\#crewai-cli-documentation)  CrewAI CLI Documentation
...
[Get Started](/introduction) ## [​](\#what-is-knowledge)  What is Knowledge?
...
[Get Started](/introduction) # [​](\#directorysearchtool)  `DirectorySearchTool`
...
[Get Started](/introduction) # [​](\#visiontool)  `VisionTool`
...
[Get Started](/introduction) # [​](\#pdfsearchtool)  `PDFSearchTool`
...
[Get Started](/introduction) ## [​](\#using-llamaindex-tools)  Using LlamaIndex Tools
...
[Get Started](/introduction) ## [​](\#understanding-processes)  Understanding Processes
...
[Get Started](/introduction) # [​](\#scrapewebsitetool)  `ScrapeWebsiteTool`
...
[Get Started](/introduction) ## [​](\#human-input-in-agent-execution)  Human input in agent execution
...
[Get Started](/introduction) # [​](\#dalletool)  `DallETool`
...
[Get Started](/introduction) ## [​](\#using-langchain-tools)  Using LangChain Tools
...
[Get Started](/introduction) # [​](\#directoryreadtool)  `DirectoryReadTool`
...
[Get Started](/introduction) # [​](\#pgsearchtool)  `PGSearchTool`
...
[Get Started](/introduction) ## [​](\#creating-and-utilizing-tools-in-crewai)  Creating and Utilizing Tools in CrewAI
...
[Get Started](/introduction) ## [​](\#introduction-to-memory-systems-in-crewai)  Introduction to Memory Systems in CrewAI
...
[Get Started](/introduction) # [​](\#txtsearchtool)  `TXTSearchTool`
...
[Get Started](/introduction) ## [​](\#overview-of-a-task)  Overview of a Task
...
### [​](\#using-output-pydantic)  Using `output_pydantic`
...
### [​](\#using-output-json)  Using `output_json`
...
#### [​](\#explanation-of-accessing-the-output-2)  Explanation of Accessing the Output
...
## [​](\#task-guardrails-2)  Task Guardrails
...
[Get Started](/introduction) ## [​](\#build-your-first-crewai-agent)  Build your first CrewAI Agent
...
#### [​](\#before-kickoff)  @before\_kickoff
...
[Get Started](/introduction) # [​](\#spidertool)  `SpiderTool`
...
[Get Started](/introduction) # [​](\#youtubechannelsearchtool)  `YoutubeChannelSearchTool`
...
[Get Started](/introduction) # [​](\#filereadtool)  `FileReadTool`
...
[Get Started](/introduction) # [​](\#firecrawlscrapewebsitetool)  `FirecrawlScrapeWebsiteTool`
...
[Get Started](/introduction) # [​](\#filewritertool)  `FileWriterTool`
...
[Get Started](/introduction) # [​](\#csvsearchtool)  `CSVSearchTool`
...
[Get Started](/introduction) # [​](\#serperdevtool)  `SerperDevTool`
...
[Get Started](/introduction) # [​](\#exasearchtool)  `EXASearchTool`
...
[Get Started](/introduction) # [​](\#what-is-crewai)  What is CrewAI?
...
[**Install CrewAI** \\
\\
Get started with CrewAI in your development environment.](/installation) [**Quick Start** \\
\\
Follow our quickstart guide to create your first CrewAI agent and get hands-on experience.](/quickstart) [**Join the Community** \\
\\
Connect with other developers, get help, and share your CrewAI experiences.](https://community.crewai.com)
...
[Get Started](/introduction) # [​](\#websitesearchtool)  `WebsiteSearchTool`
...
[Get Started](/introduction) ## [​](\#telemetry)  Telemetry
...
[Get Started](/introduction) # [​](\#mysqlsearchtool)  `MySQLSearchTool`
...
[Get Started](/introduction) # [​](\#youtubevideosearchtool)  `YoutubeVideoSearchTool`
...
[Get Started](/introduction) # [​](\#xmlsearchtool)  `XMLSearchTool`
...
[Get Started](/introduction) # [​](\#docxsearchtool)  `DOCXSearchTool`
...
[Get Started](/introduction) # [​](\#setting-a-specific-agent-as-manager-in-crewai)  Setting a Specific Agent as Manager in CrewAI
...
[Get Started](/introduction) ## [​](\#connect-crewai-to-llms)  Connect CrewAI to LLMs
...
[Get Started](/introduction) # [​](\#openlit-overview)  OpenLIT Overview
...
[Agent Monitoring with Langtrace](/how-to/langtrace-observability) [Portkey Observability and Guardrails](/how-to/portkey-observability)

![Overview Agent usage including cost and tokens](https://mintlify.s3.us-west-1.amazonaws.com/crewai/images/openlit1.png)

![Overview of agent otel traces and metrics](https://mintlify.s3.us-west-1.amazonaws.com/crewai/images/openlit2.png)

![Overview of agent traces in details](https://mintlify.s3.us-west-1.amazonaws.com/crewai/images/openlit3.png)
